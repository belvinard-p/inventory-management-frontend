...
export function EmptySalesState({ currentUser, isCreateModalOpen, setIsCreateModalOpen }: EmptyStateProps) {
      ...
      <Card>
        <CardContent className="p-12">
          <EmptyState
            ...
            description="Commencez par créer votre première vente."
...
export function LoadingSalesState() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
      ...
      <div className="space-y-4">
        <LoadingContent size="lg" text="Chargement des ventes..." className="py-12" />
      </div>
    </div>
  )
}

export function ErrorSalesState({ currentUser, isCreateModalOpen, setIsCreateModalOpen }: ErrorStateProps) {
  const hasPermission = currentUser?.roleName === 'ROLE_ADMIN' || currentUser?.roleName === 'ROLE_SALES'
