...
interface CmdSupplierLineSearchProps {
    readonly data: SupplierOrderLine[]
    readonly onFilteredData: (filtered: SupplierOrderLine[], hasFilter?: boolean) => void
    readonly placeholder?: string
}

export function CmdSupplierLineSearch({
    data,
    onFilteredData,
    placeholder = "Filtrer les lignes..."
}: CmdSupplierLineSearchProps) {
