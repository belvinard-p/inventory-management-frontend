...
import { Package, Hash, DollarSign, FileText, Tag, Truck } from "lucide-react"
import { Badge } from "@/components/ui/badge"

interface CmdSupplierLineDetailsDialogProps {
    line: SupplierOrderLine | null
    open: boolean
    onOpenChange: (open: boolean) => void
}

export function CmdSupplierLineDetailsDialog({ line, open, onOpenChange }: CmdSupplierLineDetailsDialogProps) {
    if (!line) return null
                            ...
                            <div className="flex items-center gap-4 p-4 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm font-semibold text-foreground">
                                        {line.supplierName || "Fournisseur non trouvé"}
                                    </p>
                                </div>
                            </div>
                        </div>
