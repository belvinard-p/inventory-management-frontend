        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardContent className="p-12">
                    <EmptyState
                        title={supplierOrderId ? "Aucun article dans cette commande" : "Aucune ligne de commande trouvée"}
                        description={supplierOrderId ? "Commencez par ajouter des articles à cette commande." : "Aucune ligne de commande fournisseur n'existe actuellement."}
