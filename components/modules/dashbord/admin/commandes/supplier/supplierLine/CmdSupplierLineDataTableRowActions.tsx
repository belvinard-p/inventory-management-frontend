...
import { useCmdSupplierLineContext } from "./CmdSupplierLineContext"
import { DeleteConfirmDialog } from "@/components/global"
import { CmdSupplierLineDetailsDialog } from "./CmdSupplierLineDetailsDialog"
import { useState } from "react"

interface CmdSupplierLineDataTableRowActionsProps<TData> {
    row: Row<TData>
...
export function CmdSupplierLineDataTableRowActions<TData>({
    row,
    onDelete,
    onUpdateQuantity,
    isLoading = false,
}: CmdSupplierLineDataTableRowActionsProps<TData>) {
    const line = row.original as SupplierOrderLine
    const { onEditLine } = useCmdSupplierLineContext()
